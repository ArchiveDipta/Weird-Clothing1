...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        ...
        ProductsService_1.prototype.create = function (dto, imageUrl) {
        ...
        ProductsService_1.prototype.update = function (id, dto, imageUrl) {
            return __awaiter(this, void 0, void 0, function () {
                var product, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!(imageUrl !== undefined && imageUrl !== null)) return [3 /*break*/, 4];
                            if (!product.imageUrl) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.deleteImageFile(product.imageUrl)];
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3:
                            ...
                            _a.label = 4;
                        case 4: return [2 /*return*/, this.prisma.product.update({
                                where: { id: id },
                                data: data,
                                include: { variants: true, category: true },
                            })];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3: return [2 /*return*/, this.prisma.product.delete({ where: { id: id } })];
                    }
                });
            });
        };
        // Helper: Hapus file gambar dari folder uploads
        ProductsService_1.prototype.deleteImageFile = function (imageUrl) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            console.log("\uD83D\uDDD1\uFE0F Deleted image: ".concat(filePath));
                            return [3 /*break*/, 3];
                        case 2:
                            error_1 = _a.sent();
