...
var VouchersService = function () {
    ...
    var VouchersService = _classThis = /** @class */ (function () {
        ...
        VouchersService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.voucher.create({
                            data: {
        ...
        VouchersService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.voucher.findMany()];
                });
            });
        };
        VouchersService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.voucher.findUnique({ where: { id: id } })];
                        case 1:
                            voucher = _a.sent();
                            if (!voucher)
        ...
        VouchersService_1.prototype.toggleActive = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var voucher;
                return __generator(this, function (_a) {
                    switch (_a.label) {
