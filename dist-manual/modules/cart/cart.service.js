...
var CartService = function () {
    ...
    var CartService = _classThis = /** @class */ (function () {
        ...
        CartService_1.prototype.addToCart = function (userId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.cartItem.findFirst({
                                where: { userId: userId, variantId: dto.variantId },
                            })];
                        case 1:
                            existing = _a.sent();
                            if (existing) {
        ...
        CartService_1.prototype.getCart = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.cartItem.findMany({
                            where: { userId: userId },
                            include: { variant: { include: { product: true } } },
                        })];
                });
        ...
        CartService_1.prototype.removeFromCart = function (userId, cartItemId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.cartItem.deleteMany({
