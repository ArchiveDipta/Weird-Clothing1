...
var AnalyticsController = function () {
    var _classDecorators = [(0, common_1.Controller)('analytics'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN)];
    ...
    var AnalyticsController = _classThis = /** @class */ (function () {
        ...
        AnalyticsController_1.prototype.getDashboardSummary = function () {
            return this.analyticsService.getDashboardSummary();
        };
        AnalyticsController_1.prototype.getTopProducts = function (limit) {
    ...
    (function () {
        ...
        _getDashboardSummary_decorators = [(0, common_1.Get)('dashboard')];
        _getTopProducts_decorators = [(0, common_1.Get)('top-products')];
